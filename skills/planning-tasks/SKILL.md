...
Load `${CLAUDE_PLUGIN_ROOT}/skills/detecting-provider/SKILL.md` and determine `active_provider`. Skip if already set.
Then read `${CLAUDE_PLUGIN_ROOT}/skills/providers/{active_provider}/SKILL.md` for query path detection.
